...
export function SiteFooter() {
  return (
    <Box component="footer" className="site-footer" w="100%">
      <Box className="site-footer__inner">
        <Grid gap="xl">
          <Grid.Col span={{ base: 12, md: 4 }}>
            <Stack gap="md">
              ...
              <Text c="dimmed" size="sm" maw={320}>
                A plataforma de ingressos feita para o fã brasileiro. Com alma,
