...
import { useEventsFilters } from "@/modules/catalog/hooks/useEventsFilters";
import { usePublishedEvents } from "@/modules/catalog/hooks/usePublishedEvents";
import { useSpotifyConnection } from "@/modules/integrations/hooks/useSpotifyConnection";
import {
  extractCity,
  filterEvents,
  getLowestPrice,
